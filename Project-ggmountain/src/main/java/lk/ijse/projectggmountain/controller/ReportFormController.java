...
public class ReportFormController {
    ...
    void onActionemployeeBtn(ActionEvent event) {
        InputStream resource = this.getClass().getResourceAsStream("/lk.ijse.project_ggmountain.reports/employee.jrxml");
        try {
    ...
    void onActionsupplyLoadDetailBtn(ActionEvent event) {
        InputStream resource = this.getClass().getResourceAsStream("/lk.ijse.project_ggmountain.reports/supplyLoad.jrxml");
        try {
            JasperReport jasperReport = JasperCompileManager.compileReport(resource);
            JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, DBConnection.getInstance().getConnection());
            JasperViewer.viewReport(jasperPrint, false);
